    ...
    public static class PeopleService
    {
        ...
        static PeopleService()
        {
            People = new List<Person>
            {
                ...
                //new Person { Id = 2, Name = "Name", BirthDate = new DateTime(YYYY, MM, DD), Address = new Address {Street = "Ave", City = "ville", State = "Kentucky", Zip = 40217 }, Interests = new string[] {"OneWheel", "Cats", "Final Fantasy"}},
            };          
        }
